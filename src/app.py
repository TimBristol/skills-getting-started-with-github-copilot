...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the soccer team for competitive matches and fitness training",
    ...
    "Debate Team": {
        "description": "Build argument skills, research, and compete in debate tournaments",
